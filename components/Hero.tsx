  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-coral/10 rounded-full blur-[100px]" />
      ...
      <div className="container mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button className="group flex items-center justify-center gap-2 bg-brand-coral text-white px-8 py-4 rounded-full font-semibold hover:bg-brand-coralHover hover:shadow-glow transition-all">
              <span className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                <Play size={14} fill="currentColor" />
              </span>
              Hear Our AI Agents
            </button>
            <button className="flex items-center justify-center gap-2 px-8 py-4 rounded-full border border-gray-600 text-white font-medium hover:border-brand-coral hover:text-brand-coral transition-colors">
              Get a Consultation
              <ArrowRight size={18} />
            </button>
          </div>
        ...
        >
          <div className="relative w-[300px] h-[600px] bg-brand-dark border-4 border-gray-700 rounded-[40px] shadow-2xl p-4 overflow-hidden backdrop-blur-sm bg-opacity-80">
            {/* Screen Content */}
            <div className="w-full h-full bg-gradient-to-b from-[#1a1a1a] to-[#0f0f0f] rounded-[32px] flex flex-col items-center pt-12 relative overflow-hidden">
              ...
              <div className="flex-1 w-full flex items-center justify-center gap-1">
                 {[...Array(15)].map((_, i) => (
                    <motion.div
                        key={i}
                        className="w-2 bg-brand-coral rounded-full"
                        animate={{
              ...
              <div className="w-full px-8 pb-12 flex justify-between items-end">
                  ...
                  <div className="w-16 h-16 rounded-full bg-red-500 flex items-center justify-center shadow-lg shadow-red-500/30 animate-pulse">
